...
config = {
	...
	'img_dir': './pcb_images/',
	'det_visu_path': '',
	'det_save_dir': './pcb_det_result/',
	'crop_dir': './pcb_det_result/crops/',
	'input_height': 768,
	'input_width': 768,
...
def prepare_network(config):
	net = caffe.Net(config['model_def'], config['model_weights'], caffe.TEST)
...
if __name__ == "__main__":
	...
	for f in files:
		...
		config['input_height'] = img.shape[1]
		config['input_width'] = img.shape[0]
